...
<div class = "navbar navbar-inverse navbar-fixed-top" style = "opacity: 15; color: blue">
    <div class = "container">
      <div class = "navbar-header">
        <div class = "navbar-brand">CBP Assistance Control</div>
      ...
      <div class="collapse navbar-collapse" id="navigation-bar">
        <div class="nav navbar-nav navbar-right">
          <li class="active">
            <a href="/ejemplo/grafest.php">Graficos Estadisticos</a> <!-- href='#' intercambio el # por la dirección a la que quiero enviarlo-->
          </li>
          <li>
           <a href="/ejemplo/index.php">Inicio</a>
          </li>
